...
- [Circuit DSLs and applications (circum, noir, halo2, etcc)](https://youtu.be/5YVWfj9ALF4?si=pD9IchKMYR1uJZV_)

- [By Ying Tong, more maths based](https://youtu.be/Hz_XHfxunck?si=957opY1aSy21YC-w)

- [More intuitive proofs and behind the proof](https://www.youtube.com/live/VQyDSxB9Bls?si=oLtOreTwMG6KZsiK)

- [Tornado cash, the best explanation for finite fields and discrete logarithm problem](https://youtu.be/-sXaP8Iaaq4?si=mvVdz2KV1N7cwOel)
...
-  [risc0 quick tutorial](https://dev.risczero.com/api/)
...
-  [Ethan Buchman's snark account implementation (cosmos SDK)](https://github.com/informalsystems/cosmos-sdk/blob/gnark50/simapp/gnarkcli/README.md)
-  [my ibc designs](https://github.com/Teja2045/system-designs/tree/main/zk-ibc)
-  [my draft spec](https://hackmd.io/3kBTYCo1RDyo_Qi0aAc59A?both)
